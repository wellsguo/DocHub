...
## 2.MVC设计架构  
![](https://imgcdn.sdk.cn/editor/kwI5GmfIpgwshZDvMax1.jpg)
...
### MVC代码实例
我们来看看MVC在Android开发中是怎么应用的吧！先上界面图  

![](https://imgcdn.sdk.cn/editor/7s7Rtg8XiUeTGGLv-HTZ.png)  
...
public class MainActivity extends ActionBarActivity implements OnWeatherListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherModel = new WeatherModelImpl(); // 模型实例化
        initView();
    }
...
![](https://imgcdn.sdk.cn/editor/s5ittKjxd3vpFFbxw9HT.png)
...
![](https://imgcdn.sdk.cn/editor/wcDQ3tau_S_f-UA962Ee.jpg)  
...
3、我们可以将一个Presenter用于多个视图，而不需要改变Presenter的逻辑。这个特性非常的有用，因为**视图的变化总是比模型的变化频繁**；
...
#### \*\*MVP的变种：Passive View
MVP的变种有很多，其中使用最广泛的是 Passive View 模式，即被动视图。在这种模式下，View 和 Model 之间不能直接交互，View 通过 Presenter 与 Model 打交道。Presenter 接受 View 的 UI 请求，完成简单的 UI 处理逻辑，并调用Model进行业务处理，并调用View将相应的结果反映出来。View直接依赖Presenter，但是Presenter间接依赖View，它直接依赖的是View实现的接口。

![](https://imgcdn.sdk.cn/editor/5XyC4NfMGZfH6eBAWYWj.jpg)
...
![](https://imgcdn.sdk.cn/editor/9TCk6w836WupBV8zMLc5.jpg)  
...
先来看包结构图
![](https://imgcdn.sdk.cn/editor/M_2tjrVj17Wx1qOG4Na8.jpg) 
...
![](https://imgcdn.sdk.cn/editor/4MBM4p522NX57C7UNsEV.jpg)
...
![](https://imgcdn.sdk.cn/editor/ElrtrGkAHgnzB9ka6c0x.jpg)  
...
![](https://imgcdn.sdk.cn/editor/9JC-J7b8dj3_GFcqUehY.jpg)
