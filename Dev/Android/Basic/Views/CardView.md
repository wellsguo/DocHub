银行卡设计 [implementation of credit card form in material design](https://github.com/adonixis/android-submit-credit-card-flow) 
...
作者：Microstrong0305   
来源：CSDN   
原文：https://blog.csdn.net/program_developer/article/details/54583550   
版权声明：本文为博主原创文章，转载请附上博文链接！ 

Material design 中有一种卡片设计，Google 在 v7 包中加入了 CardView 控件，谷歌官网是这样介绍的：A FrameLayout with a <u>**rounded corner background and shadow**</u>. CardView uses elevation property on L for shadows and falls back to a custom shadow implementation on older platforms. ( 也就是，CardView 一个带圆角和阴影背景的 FrameLayout。卡片视图在  lollipop (API 21) 上用 elevation 属性创建一个阴影卡片)
...
> 
作者：笔墨Android  
链接：https://www.jianshu.com/p/0c11fc6c9ff6  
来源：简书  
...
能设置的属性就这么多了，没有什么好说的。但是最后两个属性会在后面的时候详细讲解，涉及到相应的适配！

### CardView 适配
  
> 简单应用  

![](https://upload-images.jianshu.io/upload_images/2546238-1c674388c77f80fb?imageMogr2/auto-orient/strip%7CimageView2/2/w/797/format/webp)  



> 适配目标

![](https://upload-images.jianshu.io/upload_images/2546238-ad5c4b2ce12c10ac?imageMogr2/auto-orient/strip%7CimageView2/2/w/713/format/webp)  
...
- 属性2： 是否裁剪边角，以保证边角是圆形的！在21以上的版本，默认是帮你裁剪好圆角的，但是21之前的版本是不会帮你裁剪的，会出现下面这种！


![](https://upload-images.jianshu.io/upload_images/2546238-fb8cc8577d9eb9d6?imageMogr2/auto-orient/strip%7CimageView2/2/w/798/format/webp)

内边距是不见了，但是圆角的处理就成了接下来的问题了。
