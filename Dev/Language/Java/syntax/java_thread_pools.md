...
## [java 线程池](https://www.cnblogs.com/exe19/p/5359885.html) [+](http://www.cnblogs.com/dolphin0520/p/3932921.html)
...
看到没有，其实它和addIfUnderCorePoolSize方法的实现基本一模一样，只是if语句判断条件中的 `poolSize < maximumPoolSize` 不同而已。
